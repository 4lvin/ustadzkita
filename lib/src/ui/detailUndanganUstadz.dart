...
class DetailUndanganUstadz extends StatefulWidget {
  DetailUndanganUstadz({this.kode,this.nama,this.jenis,this.tema,this.tgl,this.jam});
  String kode,nama,jenis,tema,jam;
  DateTime tgl;
  @override
  _DetailUndanganUstadzState createState() => _DetailUndanganUstadzState();
}

class _DetailUndanganUstadzState extends State<DetailUndanganUstadz> {
  @override
        ...
        children: <Widget>[
          ...
          InkWell(
            onTap: () {
              ...
              getToken().then((value) => blocFitur.ustadzKonfirm(widget.kode, "Confirm", value));
                ...
                if(data.hasil){
                  ...
                  Future.delayed(Duration(seconds: 2)).then((value) {
                    ...
                    Navigator.of(context)
                        .pushNamedAndRemoveUntil('/undanganSayaUstadz2', (Route<dynamic> route) => false);
                  });
                }else{
                  Dialogs.dismiss(context);
          ...
          InkWell(
            onTap: () {
              Dialogs.showLoading(context, "Loading");
              getToken().then((value) => blocFitur.ustadzKonfirm(widget.kode, "Tolak", value));
              blocFitur.resustadzKonfirmasi.listen((data) {
                if(data.hasil){
                  Dialogs.dismiss(context);
                  Future.delayed(Duration(seconds: 2)).then((value) {
