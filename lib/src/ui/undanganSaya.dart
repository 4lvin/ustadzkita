                        ...
                        onTap: (){
                          Navigator.push(
                              ...
                              PageTransition(
                                  ...
                                  child: DetailUndangan(kode:snapshot.data.result[i].kode)));
                        },
                        child: Container(
                                          ...
                                          onTap: (){
                                            Navigator.push(
                                                ...
                                                PageTransition(
                                                    type: PageTransitionType.rightToLeft,
                                                    duration: Duration(milliseconds: 200),
                                                    child: ChatRoom(email:snapshot.data.result[i].email,nama:snapshot.data.result[i].nama,)));
                                          },
                                          child: Container(
                                            height: 30,
                                            width: 130,
...
class _DitolakState extends State<Ditolak> {
  ...
  void initState() {
    getToken().then((value){
      blocFitur.listUndangan(value,"Batal");
    });
    super.initState();
  }
  @override
